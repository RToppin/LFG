...
export const STEAM_COOP_CATALOG: SeedCatalogGame[] = [
  ...
  { name: "DayZ", sourceRank: 19, description: "Open-world survival multiplayer with persistent servers.", categories: ["Survival crafting", "Dedicated-server game"], platforms: [Platform.PC, Platform.XBOX, Platform.PLAYSTATION], supportsDedicatedServers: true },
  { name: "Hearts of Iron IV", sourceRank: 20, description: "Grand strategy multiplayer.", aliases: ["HOI4"], categories: ["Strategy"], platforms: [Platform.PC] },
  { name: "Overwatch", sourceRank: 21, description: "Team-based hero shooter.", categories: ["Team competitive"], platforms: [Platform.PC, Platform.XBOX, Platform.PLAYSTATION, Platform.NINTENDO_SWITCH] },
  { name: "Deadlock", sourceRank: 22, description: "Team-based action strategy shooter.", categories: ["Team competitive", "Strategy"], platforms: [Platform.PC] },
  { name: "Don't Starve Together", sourceRank: 23, description: "Cooperative survival crafting with persistent worlds.", aliases: ["DST"], categories: ["Survival crafting", "Cooperative campaign", "Dedicated-server game"], platforms: [Platform.PC, Platform.XBOX, Platform.PLAYSTATION], supportsDedicatedServers: true },
  { name: "Sid Meier's Civilization VI", sourceRank: 24, description: "Turn-based strategy multiplayer.", aliases: ["Civilization VI", "Civ VI", "Civ 6"], categories: ["Strategy"], platforms: [Platform.PC, Platform.XBOX, Platform.PLAYSTATION, Platform.NINTENDO_SWITCH] },
  { name: "Garry's Mod", sourceRank: 25, description: "Sandbox multiplayer with community modes and servers.", aliases: ["GMod"], categories: ["Sandbox", "Party or social", "Dedicated-server game"], platforms: [Platform.PC], supportsDedicatedServers: true },
  { name: "MECCHA CHAMELEON", sourceRank: 26, description: "Multiplayer catalog entry from the captured Steam co-op ranking.", categories: [], platforms: [Platform.PC] },
  { name: "Terraria", sourceRank: 27, description: "2D survival crafting, building, bosses, and campaign progression.", categories: ["Survival crafting", "Cooperative campaign", "Sandbox"], platforms: [Platform.PC, Platform.XBOX, Platform.PLAYSTATION, Platform.NINTENDO_SWITCH] },
  { name: "ELDEN RING", sourceRank: 28, description: "Action RPG with cooperative summoning and multiplayer sessions.", aliases: ["Elden Ring"], categories: ["Action RPG", "Cooperative campaign"], platforms: [Platform.PC, Platform.XBOX, Platform.PLAYSTATION] },
  { name: "PAYDAY 2", sourceRank: 29, description: "Cooperative heist shooter.", categories: ["Cooperative campaign", "Tactical shooter"], platforms: [Platform.PC, Platform.XBOX, Platform.PLAYSTATION] },
  { name: "tModLoader", sourceRank: 30, description: "Terraria mod loader and modded multiplayer platform.", categories: ["Sandbox", "Survival crafting"], platforms: [Platform.PC] },
  ...
  { name: "Left 4 Dead 2", sourceRank: 38, description: "Cooperative zombie campaign shooter.", aliases: ["L4D2"], categories: ["Cooperative campaign", "Horror co-op"], platforms: [Platform.PC, Platform.XBOX] },
  { name: "Forza Horizon 6", sourceRank: 39, description: "Open-world racing multiplayer.", categories: ["Racing"], platforms: [Platform.PC, Platform.XBOX] },
  { name: "FINAL FANTASY XIV Online", sourceRank: 40, description: "Online MMO with parties, duties, raids, and social play.", aliases: ["FFXIV", "Final Fantasy 14"], categories: ["MMO", "Cooperative campaign"], platforms: [Platform.PC, Platform.PLAYSTATION, Platform.XBOX] },
  { name: "Warhammer 40,000: Space Marine 2", sourceRank: 41, description: "Cooperative and competitive action shooter.", aliases: ["Space Marine 2"], categories: ["Cooperative campaign", "Team competitive"], platforms: [Platform.PC, Platform.XBOX, Platform.PLAYSTATION] },
  ...
  { name: "Factorio", sourceRank: 49, description: "Automation factory sandbox with cooperative servers.", categories: ["Sandbox", "Strategy", "Dedicated-server game"], platforms: [Platform.PC, Platform.NINTENDO_SWITCH], supportsDedicatedServers: true },
  { name: "Monster Hunter: World", sourceRank: 50, description: "Cooperative action RPG hunts and progression.", aliases: ["Monster Hunter World", "MHW"], categories: ["Action RPG", "Cooperative campaign"], platforms: [Platform.PC, Platform.XBOX, Platform.PLAYSTATION] }
];
