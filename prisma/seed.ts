...
const curatedGames: Array<Omit<SeedCatalogGame, "sourceRank"> & { source: GameSource }> = [
  {
    ...
    source: "CURATED",
    coverImageUrl: "https://www.minecraft.net/content/dam/minecraftnet/games/minecraft/key-art/Vanilla_bundle_1.png",
    fallbackGradient: "bg-gradient-to-br from-emerald-400 via-lime-700 to-sky-950",
  ...
  },
  {
    ...
    source: "CURATED",
    coverImageUrl: "https://www.minecraft.net/content/dam/minecraftnet/games/minecraft/key-art/Vanilla_bundle_2.png",
    fallbackGradient: "bg-gradient-to-br from-lime-300 via-sky-600 to-cyan-950",
  ...
  },
  {
    ...
    source: "CURATED",
    steamAppId: 2399830,
    coverImageUrl: "https://shared.cloudflare.steamstatic.com/store_item_assets/steam/apps/2399830/header.jpg",
    fallbackGradient: "bg-gradient-to-br from-cyan-300 via-teal-800 to-stone-950",
